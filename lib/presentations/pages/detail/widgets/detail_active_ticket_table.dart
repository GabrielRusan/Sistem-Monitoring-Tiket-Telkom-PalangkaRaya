...
class DetailActiveTicketTable extends StatefulWidget {
  const DetailActiveTicketTable({super.key});

  @override
  State<DetailActiveTicketTable> createState() =>
      _DetailActiveTicketTableState();
}

class _DetailActiveTicketTableState extends State<DetailActiveTicketTable> {
  @override
    ...
    return Container(
      ...
      child: Column(
        children: [
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => context
                      .read<DetailActiveTiketBloc>()
                      .add(SearchDetailActiveTiket(query: value)),
                ),
              ),
            ],
          ),
          ...
          Expanded(
            child: BlocBuilder<DetailActiveTiketBloc, DetailActiveTiketState>(
              builder: (context, state) {
                if (state.status == DetailActiveTiketStatus.empty) {
                  return const Center(
                    ...
                    columns: [
                      DataColumn2(
                        ...
                        onSort: (columnIndex, ascending) => context
                            .read<DetailActiveTiketBloc>()
                            .add(SortDetailActiveTiket(columnIndex, ascending)),
                      ),
                      DataColumn2(
                        size: ColumnSize.L,
                        label: const CustomText(
